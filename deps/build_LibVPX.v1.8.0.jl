...
download_info = Dict(
    ...
    MacOS(:x86_64) => ("$bin_prefix/LibVPX.v1.8.0.x86_64-apple-darwin14.tar.gz", "4cb4235adf065200ce29b7b1aea4042d421bfa0f96d08547da9690252c55171a"),
    ...
    FreeBSD(:x86_64) => ("$bin_prefix/LibVPX.v1.8.0.x86_64-unknown-freebsd11.1.tar.gz", "ae0d5fa6a91126c88e264d18acd365a8bf4a3a2e464d81559d178e34cbddd558"),
